...
def main():
	...
	plt.figure()
	plt.plot(t, z(t), color = 'y', linestyle="--")
	plt.plot(t, z_paw(t), color = 'b', linestyle="-")
	plt.plot(t, v_z(t), color = 'r', linestyle="-")
	plt.scatter(t_land, v_z(t_land))
	plt.scatter(t_land, z_paw(t_land))
	plt.xlabel("Temps")
